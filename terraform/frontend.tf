# =============================================================================
# Frontend — S3 + CloudFront + WAF (PDF secciones 3 y 9)
# =============================================================================
...
resource "aws_cloudfront_origin_access_control" "frontend" {
  ...
  description                       = "OAC CloudShop frontend S3"
...
resource "aws_wafv2_web_acl" "frontend" {
  ...
  description = "WAF CloudFront - CloudShop Frontend"
  scope       = "CLOUDFRONT"
  ...
  tags = merge(local.common_tags, { Name = "${local.name_prefix}-frontend-waf" })
}
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  tags = merge(local.common_tags, { Name = "${local.name_prefix}-frontend-cdn" })
